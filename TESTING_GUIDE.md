...
1. ✅ Node.js installert (v14 eller nyere)
2. ✅ npm eller yarn installert
3. ✅ React Native CLI installert
4. ✅ Android Studio (for Android) eller Xcode (for iOS)
5. ✅ Firebase-prosjekt opprettet og konfigurert
...
Åpne `src/services/firebase/config.ts` og erstatt placeholder-verdiene:
...
## Steg 3: Start Metro Bundler

```bash
npm start
```

La denne kjøre i en egen terminal.
...
### Navigasjonsfeil
- Sjekk at alle skjermer er registrert i `AppNavigator.tsx`
...
2. Test på ulike enheter (Android og iOS)
3. Test med ulike skjermstørrelser
4. Test ytelse med mange barn/logger
5. Gjennomfør sikkerhetstesting
